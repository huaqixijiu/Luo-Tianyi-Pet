...
public sealed class BodyHitMap
{
    ...
    [
        ...
        new(BodyRegionId.FaceAndMouth, new(0.29, 0.34, 0.42, 0.24)),
        new(BodyRegionId.LeftHand, new(0.20, 0.62, 0.18, 0.15)),
        new(BodyRegionId.RightHand, new(0.68, 0.62, 0.18, 0.15)),
        new(BodyRegionId.Chest, new(0.39, 0.56, 0.22, 0.17)),
        new(BodyRegionId.LowerBodySensitiveArea, new(0.43, 0.73, 0.15, 0.15)),
